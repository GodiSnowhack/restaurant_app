...
CREATE INDEX IF NOT EXISTS "ix_feedbacks_id" ON "feedbacks" (
	"id"
);
CREATE INDEX IF NOT EXISTS "ix_payments_id" ON "payments" (
	"id"
);
CREATE UNIQUE INDEX IF NOT EXISTS "ix_order_codes_code" ON "order_codes" (
	"code"
);
CREATE INDEX IF NOT EXISTS "ix_order_codes_id" ON "order_codes" (
	"id"
);
COMMIT;
