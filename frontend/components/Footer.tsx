  ...
  return (
    <footer className="bg-gray-800 text-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="#" className="text-gray-400 hover:text-gray-300 dark:text-gray-500 dark:hover:text-gray-400">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300 dark:text-gray-400">{settings.address}</span>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="h-5 w-5 mr-2 text-primary" />
                <a href={`tel:${settings.phone}`} className="text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                  {settings.phone}
                </a>
              </li>
              <li className="flex items-center">
                <MailIcon className="h-5 w-5 mr-2 text-primary" />
                <a href={`mailto:${settings.email}`} className="text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                  {settings.email}
                </a>
              </li>
              <li className="flex items-start">
          ...
          <div>
            ...
            <nav className="grid grid-cols-2 gap-y-4 sm:grid-cols-4 gap-x-6 mt-8">
              <Link href="/" className="text-base text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white" onClick={handleHomeClick}>
                Главная
              </Link>
              <Link href="/menu" className="text-base text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                Меню
              </Link>
              <Link href="/reservations" className="text-base text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                Бронирование
              </Link>
              <Link href="/about" className="text-base text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                О нас
              </Link>
              <Link href="/auth/login" className="text-base text-gray-300 hover:text-white dark:text-gray-400 dark:hover:text-white">
                Войти
              </Link>
            </nav>
          </div>
      ...
      <div className="bg-gray-900 py-4 dark:bg-black">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-[1400px] text-center text-gray-400 text-sm">
