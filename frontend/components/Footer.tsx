        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href={`tel:${settings.phone}`} className="text-gray-300 hover:text-white">
                  {settings.phone}
                </a>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <nav className="grid grid-cols-2 gap-y-4 sm:grid-cols-4 gap-x-6 mt-8">
              ...
              <Link href="/menu" className="text-base text-gray-300 hover:text-white">
                Меню
              </Link>
              <Link href="/reservations" className="text-base text-gray-300 hover:text-white">
                Бронирование
              </Link>
