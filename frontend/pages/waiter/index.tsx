      ...
      <div className="p-4 bg-white dark:bg-gray-900 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Быстрые действия</h2>
            <div className="space-y-4">
              <Link href="/waiter/bind" className="block w-full text-left py-3 px-4 rounded-md bg-indigo-50 dark:bg-indigo-900 hover:bg-indigo-100 dark:hover:bg-indigo-800 text-indigo-700 dark:text-indigo-300 transition-colors cursor-pointer">
                <div className="flex items-center">
                  <InformationCircleIcon className="h-5 w-5 mr-2" />
                  <span>Привязать заказ по коду</span>
                </div>
              </Link>
              <Link href="/waiter/create-order" className="block w-full text-left py-3 px-4 rounded-md bg-green-50 dark:bg-green-900 hover:bg-green-100 dark:hover:bg-green-800 text-green-700 dark:text-green-300 transition-colors cursor-pointer">
                <div className="flex items-center">
                  <PlusCircleIcon className="h-5 w-5 mr-2" />
                  <span>Создать новый заказ</span>
                </div>
              </Link>
              <Link href="/waiter/orders" className="block w-full text-left py-3 px-4 rounded-md bg-blue-50 dark:bg-blue-900 hover:bg-blue-100 dark:hover:bg-blue-800 text-blue-700 dark:text-blue-300 transition-colors cursor-pointer">
                <div className="flex items-center">
